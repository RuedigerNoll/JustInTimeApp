...
namespace JustInTime.Web
{
    public partial class JustInTimeAspNetApplication : WebApplication
    {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private JustInTime.Module.JustInTimeModule module3;
        private JustInTime.Module.Web.JustInTimeAspNetModule module4;
        ...
        public JustInTimeAspNetApplication()
        {
            InitializeComponent();
        }
        ...
        private void JustInTimeAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e)
        {
#if EASYTEST
			e.Updater.Update();
			e.Handled = true;
        ...
        private void InitializeComponent()
        {
            ...
            this.module4 = new JustInTime.Module.Web.JustInTimeAspNetModule();
            ...
            // sqlConnection1
            // 
            this.sqlConnection1.ConnectionString = "Integrated Security=SSPI;Pooling=false;Data Source=.\\SQLEXPRESS;Initial Catalog=J" +
                "ustInTime";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.JustInTimeAspNetApplication_DatabaseVersionMismatch);
